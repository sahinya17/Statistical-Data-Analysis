...
km_survive %>% 
  ...
  geom_step() +
  ggtitle(label = "Kaplan Meier Curve for the Survival Data")
```
...
For all of the company regardless of their sizes, they all have a rapid churned decrease for the first 4 months, and come with a flatter churned from month 6 to month 8. Next, a drop at the end of the time at month 12 except for self-employed company. For self-employed company, the survival probability stays around 50% in month 6. As there are no customers churned after month 6, there is a flat line shown in the graph.
